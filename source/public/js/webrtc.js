$(function() {
    ...
    function maybeStart() {
      ...
      console.log(App.isChannelReady);
      console.log('####################################');
      if (!isStarted && typeof localStream != 'undefined' && App.isChannelReady) {
        createPeerConnection();
        pc.addStream(localStream);
        isStarted = true;
        console.log('isInitiator', App.isInitiator);
        if (App.isInitiator) {
          doCall();
        }
      }
